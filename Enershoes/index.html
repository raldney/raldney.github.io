                                ...
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Masculino/Masculino1.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
                                            </p>
                                            <a href="http://localhost/Enershoes/detalhes.php" ><span class="card-title activator black-text text-darken-4">Masculino</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12 m4">
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Masculino/Masculino2.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
                            ...
                            <div class="col s12 m4">
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Masculino/Masculino4.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
                            ...
                            <div class="col s12 m4">
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Feminino/Feminino1.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
                                            </p>
                                            <a href="http://localhost/Enershoes/detalhes.php" ><span class="card-title activator black-text text-darken-4">Feminino</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col s12 m4">
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Feminino/Feminino2.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
                            ...
                            <div class="col s12 m4">
                                <div class="col s12 m4  l12 ">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="http://localhost/Enershoes/detalhes.php">
                                            <img src="images/Feminino/Feminino4.png" class="responsive-img" alt="">
                                            </a>
                                        </div>
                                        <div class="card-content">
                                            <p class="area"><a href="http://localhost/Enershoes/detalhes.php">ENERSHOES</a>
